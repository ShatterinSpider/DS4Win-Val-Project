...
Doing this stops Valorant from causing these specific issues while playing with a controller: Crashing or Freezing upon opening the game, crashing while alt tabbed. 
Current issues: Input Buffering MID GAME, no idea why this happens but started only recently. 
